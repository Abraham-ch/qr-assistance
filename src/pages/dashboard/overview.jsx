        ...
        <table className="w-full divide-y divide-gray-300 bg-gray-100 text-sm text-gray-900 border border-gray-300">
          <caption className="py-3 pb-3 text-gray-800 text-start text-sm pl-4">
            <div className='flex justify-between items-end'>
              <p className='sm:block hidden'>Lista de alumnos registrados.</p>
          ...
          <thead className="bg-gray-200 text-left text-gray-800">
            <tr>
              <th className="py-3 px-4 max-w-[180px] text-xs sm:text-sm">ID</th>
              <th className="py-3 px-4 max-w-[120px] text-xs sm:text-sm">Alumno</th>
              <th className="py-3 px-4 sm:table-cell hidden">Nivel</th>
              <th className="py-3 px-4 sm:table-cell hidden">Grado</th>
              <th className="py-3 px-4 pr-6 text-right text-xs sm:text-sm max-w-[100px]">Asistencia</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-300">
            {students.map((student) => (
              <tr key={student.id} className="text-left">
                <td className="py-3 px-4 font-medium text-xs sm:text-sm">{student.id}</td>
                <td className="py-3 px-4 max-w-[120px] text-xs sm:text-sm">{student.nombre} {student.apellido}</td>
                <td className="py-3 px-4 sm:table-cell hidden">{student.nivel}</td>
                <td className="py-3 px-4 sm:table-cell hidden">{student.grado}</td>
                <td className='py-3 px-4 pr-6 text-right text-xs sm:text-sm max-w-[100px]'>Activo</td>
